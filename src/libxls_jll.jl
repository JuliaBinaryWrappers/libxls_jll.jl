...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libxls_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("86717fa1-76ed-5f2d-aba0-009d7207923f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libxls", artifacts_toml) for e in artifacts["libxls"]]
...
if best_platform === nothing
    @debug("Unable to load libxls; unsupported platform $(triplet(platform_key_abi()))")
else
